...
image:https://shields.io/badge/Application Maintenance API-1.4.1-green?logo=swagger[link="https://github.com/gematik/api-vzd/blob/I_Directory_Application_Maintenance/1.4.1/src/openapi/DirectoryApplicationMaintenance.yaml"]

== Aktuelles


* *27.10.2023* 👨‍💻 https://github.com/gematik/api-vzd/blob/gemILF_VZD_FHIR_Directory/1.1.0/docs/gemILF_VZD_FHIR_Directory.adoc[FHIR VZD Implementierungsleitfaden v1.1.0]
