...
* image:https://shields.io/badge/-Neu-red[Neu] https://fachportal.gematik.de/fileadmin/Fachportal/Downloadcenter/Implementierungsleitfaeden/gemILF_Pflege_VZD_V1.5.1.pdf[gemILF_Pflege_VZD_V1.5.1.pdf]
