...
image:https://shields.io/badge/simplifier.net-0.10.0-red[link="https://simplifier.net/vzd-fhir-directory"] +
...
* *11.04.2023* 🔥 https://simplifier.net/packages/de.gematik.fhir.directory/0.10.0/~introduction[FHIR Package 0.10.0]
