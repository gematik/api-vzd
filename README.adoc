...
image:https://shields.io/badge/Admin API-latest-green?logo=swagger[link="src/openapi/DirectoryAdministration.yaml"]
...
* *8.04.2022* 👨‍💻 https://github.com/gematik/api-vzd/tree/I_Directory_Administration/1.8.1[Directory Administration API v1.8.1]
...
8. _In Entwicklung_: VZD bietet direkten Zugriff zur den Daten über FHIR REST Schnittstellen für die TIM Clients und perspektivisch anderen registrierten Clients. Schnittstelle `I_Directory_FHIR#tim-search`.
