...
image:https://shields.io/badge/develop-green[link="https://github.com/gematik/api-vzd/blob/DirectoryAdministration/develop/src/openapi/DirectoryAdministration.yaml"]
...
* https://fachportal.gematik.de/fileadmin/Fachportal/Downloadcenter/Implementierungsleitfaeden/gemILF_Pflege_VZD_V1.5.1.pdf[gemILF_Pflege_VZD_V1.5.1.pdf]
