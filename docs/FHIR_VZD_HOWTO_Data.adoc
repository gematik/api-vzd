...
|1.0.0 |02.12.25 | |Update according Simplifier profile 1.0.0 |gematik
|1.0.1 |06.03.26 | |Links updated |gematik
|===
...
| https://simplifier.net/vzd-fhir-directory/organizationdirectory[National Contact Point of Health (NCPeH) Country Extension - Organization.extension:ncpehCountryEx]
|0..* 
|The country for which the National Contact Point of Health (NCPeH) is responsible. +
Values: link:http://hl7.org/fhir/ValueSet/iso3166-1-2[Iso3166-1-2]
|No
|Yes
...
|providerType 
|0..* 
|According to FHIR profile https://simplifier.net/vzd-fhir-directory/organizationdirectory[Organization.type:providerType] +
...
|0..1
|Only used for the "NCPeH Fachdienst" in the FHIR VZD (code: "1.2.276.0.76.4.292").
|No
|No
...
|Yes
|No, Yes for pharmacies, Yes for owner-resources
...
|No
|Yes for owder resources.

|telecom  
|A contact detail for the organization  
|0..* 
|Is used for pharmacies. May contain website, email, telephone, fax. +
...
The kind of organization is stored in the Organization.type attribute. For pharmacies the following codes from https://simplifier.net/vzd-fhir-directory/organizationdirectory[Organization.type:profession] are relevant:
