...
|===
Simplifier: https://simplifier.net/vzd-fhir-directory/practitionerdirectory[Organization-Resource] +
...
|===
Simplifier: https://simplifier.net/vzd-fhir-directory/practitionerroledirectory[HealthcareService-Resource] +
