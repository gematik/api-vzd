...
| https://simplifier.net/vzd-fhir-directory/organizationvisibilitycs[National Contact Point of Health (NCPeH) Country Extension
] 
|0..1 
...
| https://simplifier.net/vzd-fhir-directory/ncpehcountryex[OrganizationVisibilityCS] 
|0..* 
|The country for which the National Contact Point of Health (NCPeH) is responsible. +
Values: https://simplifier.net/packages/hl7.fhir.r4.core/4.0.1/files/79837[Iso3166-1-2]
|No
|No
