...
| `mail`
| KIM-Adresse
| zur Kompatibilität bleibt die KIM Mail Adresse in diesem Attribut erhalten

| `komLeData.mail`
| KIM-Adresse
| Liste von KIM-Adressen mit der zugehörigen KIM-Version im Attribut komLeData.version

| `komLeData.version`
| KIM-Version
| KIM-Version der zugeordneten KIM-Adresse
