...
| `otherName`
| Weitere Name(n)
| Es wird nicht mehr empfohlen dieses Attrit zu verwenden.
...
| `specialization`
| Fachgebiet
| Der Wertebereich entspricht den in hl7 definierten und für ePA festgelegten Werten:
...
https://github.com/hl7germany/de.basisprofil.terminology/blob/main/fsh-generated/resources/CodeSystem-codesystem-nicht-aerztliche-fachrichtungen-ihe-xds.json
