...
Die Abbildung zeigt das FHIR-Directory mit seinen Schnittstellen und Nutzern.

.Überblick Nutzer und Rollen
|===
...
|Die TI-Messenger Anbieter nutzen die Schnittstelle (4) um die Föderationsliste des TI-Messengers abzufragen und um ihre TI-Messenger Domains als Teil der TI-Messenger Föderation zu verwalten.
