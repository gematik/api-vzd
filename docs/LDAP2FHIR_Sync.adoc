...
.2+|domainID |HBA |spezifisches Kennzeichen des Sektors | jeweilige Resource | identifier |Bezeichner: domänenspezifisches Kennzeichen des Eintrags. kann mehrfach vorkommen (0..100)
