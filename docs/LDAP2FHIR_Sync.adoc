...
|Umgang mit "komLeData", "mail", "maxKOMLEadr" festlegen -> warum diese entfallen, nicht weiterbetrachtet werden..mail |KIM Adresse| Endpoint.address | KIM Adresse aus kimData.mail 
...
- "maxKOMLEadr" war nur für Kassen relevant und kann wegen der Nutzung von den appTags im FHIR VZD entfallen. Dieses Attribut wird deshalb nicht in den FHIR VZD synchronisiert.
- LDAP "noVzdMailEntry" Parameter für KIM-Adessen ...
