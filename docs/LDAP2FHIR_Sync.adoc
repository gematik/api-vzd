...
|Endpoint.connectionType  | Abbildung auf https://simplifier.net/vzd-fhir-directory/endpointdirectoryconnectiontype[EndpointConnectionTypeVS] (muss für KIM angepasst werden)
|Endpoint.version*  | Die KIM Version wird aus dem LDAP Attribut kimData.version entnommen und in dieses Endpoint Attribut übernommen.
