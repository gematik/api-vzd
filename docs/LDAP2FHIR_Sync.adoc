...
- Aufnahme in den Volltextindex: Endpoint.address, Endpoint.connectionType, Endpoint.payloadType (für alle Endpoints, nicht auf KIM-Adressen beschränkt), Endpoint.status als z.B. "Endpoint.status.active"
