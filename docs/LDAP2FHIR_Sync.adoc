...
|Endpoint.connectionType  Extension "xxlMailSupported" | Die KIM Option "große Mails" wird aus dem LDAP Attribut kimData.version entnommen ("\+" am Ende des LDAP Attributs) und in connectionType Extension (unter kimVersion) "xxlMailSupported" als "true" übernommen. Falls kein "+" am Ende des LDAP Attributs vorhanden ist, wird xxlMailSupported auf "false" gesetzt.
...
- Endpunkte dürfen in jedem Status (z.B. Endpoint.status, Organization.active, Practitioner.active) angelegt, geändert und gelöscht werden.
...
- Der VZD muss für KIM Endpunkte sicherstellen, dass sie nur mit einem HelathcareService verlinkt werden.
...
- Aufnahme in den Volltextindex (_text) von HealthcareService und PractitionerRole: Endpoint.address - Adresse der Endpunkte. “tim”,”tim-chat”, “tim-bot” = Matrix-Adresse, “kim” = E-Mail-Adresse.
- Aufnahme in den Volltextindex (_text) von Endpunkten: Endpoint.address - Adresse der Endpunkte. “tim”,”tim-chat”, “tim-bot” = Matrix-Adresse, “kim” = E-Mail-Adresse.
