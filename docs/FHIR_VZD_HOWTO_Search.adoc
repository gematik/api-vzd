...
link:../samples/FHIRseach/Search_PractitionerRole_name.adoc[FHIRseach/Search_PractitionerRole_name] +
 +
...
.Response of this Request: 
link:../samples/FHIRseach/Search_PractitionerRole_payload-type.adoc[FHIRseach/Search_PractitionerRole_payload-type] +
 +
