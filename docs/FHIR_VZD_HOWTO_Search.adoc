...
Typically no complex search is needed by clients. For this reason, all HAPI-FHIR defined special characters in the full-text search _text attribute are ignored by default.
