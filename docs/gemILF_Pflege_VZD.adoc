...
- Zuordnung von VZD Einträgen (TelematikIDs) zu Attributtabellen ergänzt. +
- Prüfung V004: Link auf Simplifier aktualisiert +
- Attribut "lanr" ergänzt +
- Kapitel umbenannt in "gematik - Weitere Kostenträger und PKV (SMC-B-Eintrag)" +
- Tab_VZD_Datenbeschreibung_der_SMC-B_KT_PKV Beschreibung domainID erweitert +
- Tabelle für NCPeH ergänzt
|gematik
|1.5.14 |08.04.2025 |3.7 +
4.17
|
- Prüfung V004: Link auf Simplifier aktualisiert +
- Korrektur Fachrichtungen/ specialization für Handwerkskammern
|gematik

|1.5.15 |20.05.2025 |3.7 +
 +
 +
4.15
|
- regEx für Kap. 4.8 aktualisiert +
- Regel V009 auf umgesetzt gestellt +
- Regel 15 bzgl. CountryCode-Setzung ergänzt +
- Tab_VZD_Datenbeschreibung_der_SMC-B_KT_PKV - domain Beschreibung aktualisiert
|gematik

|1.5.16 |19.09.2025 |4.17 & 4.18
|
- Beschreibung "holder" Attribut aktualisiert 
|gematik

|1.5.17 |23.09.2025 |4.1
|
- Default Wert für countryCode entfernt 
|gematik

|1.5.18 |11.03.2026 |4.1
|
- Für SMC-B Einträge givenName in Spalte "Pflichtfeld" auf "unzulässig" gesetzt 
|gematik
|===
...
Neue Versionen der Schnittstelle und dieser Anleitung werden über https://gemspec.gematik.de/[+++gemSpecPages+++] veröffentlicht.
...
Beim Hinzugefügen und Ändern von Daten im VZD müssen die übergebenen Daten den xref:gemILF_Pflege_VZD.adoc#Tabelle_Plausi[Prüfungen beim Eintragen von Daten zur Verbesserung der Datenqualität] und den Vorgaben in den Attributtabellen von Kapitel 4 entsprechen.
...
* (optional)*  ::
_Query Parameter_ — Erlaubt die Suche mit Hilfe des Attributs . 
...
wobei CodeSystems und Codes aus  https://simplifier.net/vzd-fhir-directory/healthcareservicetypevs[HealthcareServiceTypeVS]  
zu entnehmen sind.
|V005 |umgesetzt |ja
...
|V014 |umgesetzt |nein
| Bei Organisationseinträgen werden die für Personen vorgesehene Felder  und title abgelehnt: +
...
|V015 |umgesetzt |nein
| Der Standardwert „DE“ für den CountryCode wird bei der Anlage (AddDirectoryEntry) und Aktualisierung (ModifyDirectoryEntry) über den REST-Service RsDirectoryAdministration nicht mehr automatisch gesetzt. Bei der Anlieferung einer PLZ, StateOrProvince, City, Straße muss ein CountryCode obligatorisch angeliefert. Nicht-Anlieferung führt zu einem "Bad Request"-Fehler (Fehlercode 400)
|===

{empty} +
{empty} +
[[Tabelle_TID_Mapping]]
Die folgende Tabelle beschreibt, wie die VZD Einträge anhand ihrer TelematikID den Attributtabellen in Kapitel 4 zugeordnet werden. 
Für die VZD Einträge werden die Vorgaben aus den Attributtabellen entsprechend dieser Zuordnung durch den VZD geprüft.
Der Wert in Spalte "TelematikID (regEx)" ist ein Regulärer Ausdruck (Regular expression), der die zugeordneten TelematikIDs beschreibt.

[width="100%",options="header",]
|===
|*Kapitel*|*Tabelle* |*TelematikID (regEx)* 
|4.2| xref:gemILF_Pflege_VZD.adoc#Tabelle_2[Tabelle 2: Tab_VZD_Datenbeschreibung_KVen] a|"^1-20.*"
|4.3| xref:gemILF_Pflege_VZD.adoc#Tabelle_3[Tabelle 3: Tab_VZD_Datenbeschreibung_KZVen] a|"^2-2.*"
|4.4| xref:gemILF_Pflege_VZD.adoc#Tabelle_4[Tabelle 4: Tab_VZD_Datenbeschreibung_Apotheken_SMC-B] a|"(\^3-...2.\*\|^9-2.54.*)"
|4.5| xref:gemILF_Pflege_VZD.adoc#Tabelle_5[Tabelle 5: Tab_VZD_Datenbeschreibung_Apotheker_ Pharmazieingenieure_Apothekerassistenten] a|"(\^3-...3.\*\|^9-1.(32\|33\|34).*)"
|4.6| xref:gemILF_Pflege_VZD.adoc#Tabelle_6[Tabelle 6: Tab_VZD_Datenbeschreibung_DKTIG (DKG)] a|"^5-.*"
|4.7| xref:gemILF_Pflege_VZD.adoc#Tabelle_7[Tabelle 7: Tab_VZD_Datenbeschreibung_Psychotherapeuten] a|"^4-1.*"
|4.8| xref:gemILF_Pflege_VZD.adoc#Tabelle_8[Tabelle 8: Tab_VZD_Datenbeschreibung_BÄK] a|"^1-1*"
|4.9| xref:gemILF_Pflege_VZD.adoc#Tabelle_9[Tabelle 9: Tab_VZD_Datenbeschreibung_BZÄK] a|"^2-0?1.*"
|4.10| xref:gemILF_Pflege_VZD.adoc#Tabelle_10[Tabelle 10: Tab_VZD_Datenbeschreibung_GKV-SV_SMC-B KTR] a|"^8-01.*"
|4.10| xref:gemILF_Pflege_VZD.adoc#Tabelle_11[Tabelle 11: VZD_Datenbeschreibung_GKV-SV_SM-B_KTR ePA] a|"^8-(03\|04).*"
|4.11| xref:gemILF_Pflege_VZD.adoc#Tabelle_12[Tabelle 12: Tab_VZD_Datenbeschreibung_der_SMC-B_Org] a|"^9-2.(58\|187\|210\|223\|226\|227\|228\|224\|225\|229\|230\|231\|242\|243\|244\|245\|262\|263\|264\|265\|266\|267\|268\|269\|270\|271\|284\|285\|286\|295).*"
|4.12| xref:gemILF_Pflege_VZD.adoc#Tabelle_13[Tabelle 13: Tab_VZD_Datenbeschreibung_der_SMC-B_eGBR] a|"^10-67.(245\|246\|247\|278\|279\|280\|281\|311).*"
|4.13| xref:gemILF_Pflege_VZD.adoc#Tabelle_14[Tabelle 14: Tab_VZD_Datenbeschreibung_eGBR_HBA] a|"^10-67.(232\|233\|234\|235\|236\|274\|275\|276\|277\|312).*"
|4.14| xref:gemILF_Pflege_VZD.adoc#Tabelle_15[Tabelle 15: Tab_VZD_Datenbeschreibung_der_SMC-B_WÄI] a|"^9-2.(50\|51\|34\|254\|255\|256).*"
|4.15| xref:gemILF_Pflege_VZD.adoc#Tabelle_16[Tabelle 16: Tab_VZD_Datenbeschreibung_der_SMC-B_KT_PKV] a|"^9-2.(59\|273\|303).*"
|4.16| xref:gemILF_Pflege_VZD.adoc#Tabelle_17[Tabelle 17: Tab_VZD_Datenbeschreibung_der_SMC-B_DiGA] a|"^9-2.282.*"
|4.17| xref:gemILF_Pflege_VZD.adoc#Tabelle_18[Tabelle 18: Tab_VZD_Datenbeschreibung_der_SMC-B_HWK] a|"^11-2.*"
|4.18| xref:gemILF_Pflege_VZD.adoc#Tabelle_19[Tabelle 19: Tab_VZD_Datenbeschreibung_BA_HWK] a|"^11-1.*"
|4.19| xref:gemILF_Pflege_VZD.adoc#Tabelle_20[Tabelle 20: Tab_VZD_Datenbeschreibung_NCPeH] a|"^9-2.292.*"
|===
...
|countryCode |Werte gemäß  ISO-3166-1 ALPHA-2 |Der Standardwert „DE“ für den CountryCode wird bei der Anlage und Aktualisierung nicht automatisch gesetzt. Bei der Anlieferung einer PLZ, StateOrProvince, City, Straße muss ein CountryCode obligatorisch angeliefert. Nicht-Anlieferung führt zu einem "Bad Request"-Fehler (Fehlercode 400)
|===
{empty} +
{empty} +
...
|*givenName* |unzulässig |Wird für SMC-B nicht verwendet.
...
|*lanr* |optional |Wird für SMC-B nicht verwendet.
...
Default für das Attribut ist LEER. LEER wird in der eRezept Anwendung gleich behandelt wie "Sonstige_offen". +
 +
Hinweis: Beim Eintragen und Ändern der Spezialisierung über die REST Schnittstelle (I_Directory_Administration) müssen nur die Codes angegeben werden, keine weiteren Werte. +
Beispiele: Für "10 Offizin-Apotheke" aus https://simplifier.net/vzd-fhir-directory/pharmacytypeldapcs[PharmacyTypeLDAPCS] muss übergeben werden: *"10"* +
Für "10 Offizin-Apotheke" UND "40 Versandapotheke" muss übergeben werden: *"10","40"* +
 +
...
|*telematikID* |obligatorisch |Bezeichner: TelematikID +
Wird vom VZD anhand der im jeweiligen Zertifikat enthaltenen Telematik-ID (Feld registrationNumber der Extension Admission) übernommen.
|*lanr* |optional |Wird für diese Berufsguppe(n) nicht verwendet.
|*dataFromAuthority* |optional |Wird vom VZD eingetragen +
Gibt an, ob die Daten vom Kartenherausgeber stammen. +
Wert == TRUE, wenn der Verzeichnisdienst_Eintrag von dem Kartenherausgeber geschrieben wurde, Wert == FALSE sonst
  +
...
|*telematikID* |obligatorisch |Bezeichner: TelematikID +
Wird vom VZD anhand der im jeweiligen Zertifikat enthaltenen Telematik-ID (Feld registrationNumber der Extension Admission) übernommen.
|*lanr* |optional |Bezeichner: LANR +
Die lebenslange Arztnummer, kurz LANR, dient der Suche nach Ärzten. 
Insbesondere für die Suche durch Clients, welche die TelematikID nicht vorliegen haben.
|*dataFromAuthority* |optional |Wird vom VZD eingetragen +
Gibt an, ob die Daten vom Kartenherausgeber stammen. +
Wert == TRUE, wenn der Verzeichnisdienst_Eintrag von dem Kartenherausgeber geschrieben wurde, Wert == FALSE sonst
  +
...
=== gematik - Weitere Kostenträger und PKV (SMC-B-Eintrag)
[[Tabelle_16]]
...
|*organization* |optional |Bezeichner: Organisation +
Dieses Attribut ist ein optionales zweites Namensattribut und wird befüllt bei Bedarf. Ebenso wie displayName ist es geeignet, um nach einem Namen zu filtern und ihn im Suchergebnis anzuzeigen.
|*domainID* a|obligatorisch +
 +
 +

optional a| Obligatorisch für alle VZD-Einträge mit dem Institutionskennzeichen (IK) zu befüllen, deren TelematikID mit folgenden Prefixen beginnt:

- 9-2.59.*  (Private Krankenversicherung oder Weiterer Kostenträger)

Für alle anderen VZD-Einträge: nicht belegt
...
urn:psc:1.3.6.1.4.1.19376.3.276.1.5.4:AUGE +
Betriebsstätte Hörakustiker: +
urn:psc:1.3.6.1.4.1.19376.3.276.1.5.4:HNOH +
Betriebsstätte Orthopädieschuhmacher: +
urn:psc:1.3.6.1.4.1.19376.3.276.1.5.4:ORTH +
Betriebsstätte Orthopädietechniker: +
urn:psc:1.3.6.1.4.1.19376.3.276.1.5.4:ORTH +
Betriebsstätte Zahntechniker: +
urn:psc:1.3.6.1.4.1.19376.3.276.1.5.4:MZKH +
...
Wenn der Wert TRUE ist, können die Daten nicht mehr über die Schnittstelle I_Directory_Maintenance bearbeitet werden. Die Schnittstelle I_Directory_Maintenance wird von KOM-LE-Anbietern verwendet.
|*holder* |obligatorisch |Festlegung Änderungsrechte: +
Wert „clientID“ der Handwerkskammer („HWK<ID>“) und die „clientID“ des eintragenden TSP +
Kürzel "HWK<ID>" mit ID aus den letzten beiden Ziffern der Handwerkskammer-ID (die drei führenden Nullen fallen weg) gemäß +
...
|===
|*LDAP-Directory Attribut* |*Pflichtfeld aus Sicht Pflege und Nutzung?* |*Erläuterung*
|*givenName* |unzulässig |Wird für den NCPeH nicht verwendet.
...
|[gemSpec_VZD] |gematik: Spezifikation Verzeichnisdienst - Version: 1.18.0
|===
