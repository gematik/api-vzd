...
-	Abgelaufene Zertifikate entfernt der VZD automatisch. +
...
Wird vom KOM-LE-Anbieter eingetragen. +
 +
Hinweis: Für KOM-LE wird in der externen Darstellung die Bezeichnung "KIM" genutzt. In den Spezifikationen wird aber noch der Begriff KOM-LE genutzt. 
