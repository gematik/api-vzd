...
|V006 |umgesetzt |ja
| Überschreibt V004 für den Sektor der Apotheken. Bei SMC-B Einträgen füt Apotheken müssen für das Attribut specialization die Codes aus https://simplifier.net/packages/de.gematik.fhir.directory/0.10.2/files/2140635[PharmacyTypeCS] (nur Code, ohne CodeSystem) verwendet werden.
// bisher V008  
|V007 |umgesetzt |nein
...
|*specialization* |optional |Im Attribut specialization werden die ApothekenTypen (OffizinApo, Versand etc) erfasst. Hierfür wird das dafür definierten CodeSysteme https://simplifier.net/packages/de.gematik.fhir.directory/0.10.2/files/2140635[PharmacyTypeCS] genutzt . Die Inhalte werden durch die Kartenherausgeber gepflegt. +
