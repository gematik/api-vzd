...
|gematik
|1.5.5 |30.09.2022  |4.* |- Beschreibung der Attribute aktualisiert (givenName, sn, cn, displayName, entryType) - DIR-214, DIR-236 +
- „read only“ Zugang aufgenommen (Kap. 3.1.1, 3.2) - C_11187, DIR-83 +
- Beschreibung von Attribut personalEntry aktualisiert - C_11227, DIR-174 +
- Attribute active und meta und Operation stateSwitch_Directory_Entry aufgenommen - C_11183 DIR-119 +
- Operation readLog aufgenommen - C_11221, DIR-6 +
- Beschreibung Attribut changeDateTime aktualisiert - C_11183, DIR-80 +
- Attribute notBefore, notAfter aufgenommen - C_11179, DIR-203
...
Wird vom VZD anhand der im Zertifikat enthaltenen OID (Extension Admission, Attribut ProfessionOID) und der Spalte Eintragstyp in Tab_VZD_Mapping_Eintragstyp_und_ProfessionOID automatisch eingetragen. Siehe auch [gemSpecOID]# Tab_PKI_402 und Tab_PKI_403. +
 +
