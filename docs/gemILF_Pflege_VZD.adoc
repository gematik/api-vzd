...
|*specialization* |optional |Im Attribut specialization werden die ApothekenTypen (OffizinApo, Versand etc) erfasst. Hierfür wird das dafür definierte CodeSystem genutzt. Die Inhalte werden durch die Kartenherausgeber gepflegt. +
Default für das Attribut ist LEER bzw. nicht vorhanden, was in der eRezept Anwendung gleich behandelt wird wie "Offizin-Apotheke". +
 +
