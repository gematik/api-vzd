...
|1.5.3 |​ |3.6 |Rückverfolgbarkeit der Einträge (Holder-Attribute) - C_11048 +
TODO: Link vor Veröffentl. entfernen +
https://service.gematik.de/browse/DIR-84.[+++https://service.gematik.de/browse/DIR-84.+++]  |gematik
|===
...
_Please update the table of contents._
...
image:gemILF_Pflege_VZD-media/media/image1.png[image,width=604,height=324]
...
image:gemILF_Pflege_VZD-media/media/image2.png[image,width=604,height=536]
...
*Zukünftige Verwendung von client_id und holder:*

Bei der Beantragung der Credentials zur Nutzung der Schnittstelle wird auch die client_id abgefragt. Die client_id ist im Access Token enthalten und wird vom VZD ausgewertet. Der holder kann über die REST-Schnittstelle beim Erzeugen oder Ändern des Eintrags gesetzt werden und auch mehrere Werte sind für holder möglich. Der Inhalt der client_id im Access Token wird mit dem Inhalt des holder-Attributs im VZD-Eintrag verglichen. Bei Übereinstimmung darf der Eintrag geändert werden. Wenn der holder nicht vorhanden oder leer ist, darf der Eintrag geändert werden. Wenn client_id und holder nicht übereinstimmen, darf der Eintrag nicht geändert werden. Dadurch kann der Kartenherausgeber den oder die Werte für holder zu einem ihm passenden Zeitpunkt setzen und der Eintrag ist von da an vor Veränderung durch andere Kartenherausgeber geschützt. Falls ein Kartenherausgeber sich unberechtigt als holder für einen Eintrag angegeben hat, kann man das über das Logfile des VZD herausfinden und zwischen den betroffenen Kartenherausgebern zur Klärung bringen.
...
|===
|*orange* |Das Attribut muss von der pflegenden Stelle (Kartenherausgeber oder vom Kartenherausgeber berechtigte Organisationen wie z. B. TSP) aus dem Zertifikat ermittelt und über die Schnittstelle I_Directory_Administration an den VZD übergeben werden.
