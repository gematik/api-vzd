...
----
Der Auth-Service des VZD-FHIR-Directory muss übergebene Token entsprechend Akzeptanzkriterium ML-xxxxxx prüfen und bei 
erfolgreicher Prüfung ein owner-accesstoken ausstellen und zurückgeben.
