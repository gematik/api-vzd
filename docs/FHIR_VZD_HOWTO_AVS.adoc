...
*5. Aktualisierung des HealthcareService* +
 +
Link zum Endpoint ("id") in HCS eintragen. +


*6. Aktualisierung des HealthcareService* +
 +
Schreiben des aktualisierten HealthcareService in den FHIR VZD
 +
Das AVS schreibt den - in Punkt XXX aktualisierten - HealthcareService mit einer FHIR PUT Operation in den FHIR VZD.
