...
*Besonderheiten bei der Eintragung von Schließzeiten*

Bei der Eintragung von Schließzeiten sollten Sie folgende Punkte beachten:
...
-----
=====
- gleiche Anfangs- und Endzeit mit Zeitangabe führt zur Schließung von nur 1 Sekunde
=====
[source,txt, linenums]
-----
{
...
-----
=====
- stattdessen sollte ein ganzer Schließtag folgendermaßen abgebildet werden:
=====
[source,txt, linenums]
-----
{
