...
Eine Apotheke/Organization kann im FHIR VZD mehrere HealtcareServices haben. 
...
====
Die Mehrwertdaten müssen durch das AVS in den HealtcareService - markiert mit Code "ldap" - a. 
