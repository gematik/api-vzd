...
- HealthcareService.specialty can be set be set to a subset of the synchronized HealthcareService.specialty (Please note that the modification of the speciality is implemented but not yet deployed).
...
- Endpoint.status - The state of the Endpoint has to be "active".
...
IMPORTANT:  This feature is under development and not yet contained in a test FHIR VZD
