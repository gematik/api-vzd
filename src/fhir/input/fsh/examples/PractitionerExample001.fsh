...
* qualification[+].code = KBV_CS_SFHIR_BAR2_WBO_OID_URL#010 "FÄ/FA Allgemeinmedizin (alte (M-)WBO, kammerindividuell, EU-Ärzte)"
* qualification[+].code = KBV_CS_SFHIR_BAR2_WBO_OID_URL#523 "FÄ/FA Innere Medizin und (SP) Gastroenterologie"
* name
  * prefix = "Dr."
  * given[+] = "Max"
  * given[+] = "Manfred"
